...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tundra = __webpack_require__(162);

	var _tundra2 = _interopRequireDefault(_tundra);
	...
	var TodoItem = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      this.props.item.pending && _react2.default.createElement("img", { className: "spinner", src: "loading.gif", width: "24", height: "24" })
	    );
	  },
	...
	var App = _react2.default.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    this.client = new _tundra2.default("todos");
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _freezerJs = __webpack_require__(163);
	...
	var Tundra = function () {
	  function Tundra(collection) {
	    var _this = this;

	    _classCallCheck(this, Tundra);

	    this.store = new _freezerJs2.default([]);
	    this.collection = horizon(collection);

	    this.collection.watch({ rawChanges: true }).forEach(function (_ref) {
	      ...
	      if (type === "initial") store.push(new_val);else if (type === "remove") store.reset(store.filter(function (x) {
	  ...
	  _createClass(Tundra, [{
	    ...
	    key: "update",
	    value: function () {
	      var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(item, props) {
	        var ref;
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 3:
	                _context.prev = 3;
	                _context.next = 6;
	                return this.collection.update(_extends({ id: item.id }, props)).toPromise();
	    ...
	    key: "add",
	    value: function () {
	      var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(props) {
	        var newItem, store;
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                ...
	                this.store.get().push(_extends({}, newItem, { pending: "add" }));
	              ...
	              case 4:
	                _context2.prev = 4;
	                _context2.next = 7;
	                return this.collection.store(newItem).toPromise();
	          ...
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              ...
	              case 3:
	                _context3.prev = 3;
	                _context3.next = 6;
	                return this.collection.remove(item.id).toPromise();
	...
	exports.default = Tundra;

/***/ },
/* 163 */
/***/ function(module, exports, __webpack_require__) {

	var Freezer = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Utils = __webpack_require__( 165 ),
		Emitter = __webpack_require__( 166 ),
		Mixins = __webpack_require__( 167 ),
		Frozen = __webpack_require__( 168 )
	;
